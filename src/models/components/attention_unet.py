...
class AttentionUnet(nn.Module):
    def __init__(self, img_depth, device):
        ...
        self.down3 = Down(256, 512 // factor) ## 256, 256
        self.up1 = Up(512, 256 // factor, bilinear) ## 512, 128
        self.up2 = Up(256, 128 // factor, bilinear) ## 256, 64
        self.up3 = Up(128, 64, bilinear) ## 128, 64
        self.outc = OutConv(64, img_depth) ## 64, 1
    ...
    def pos_encoding(self, t, channels, embed_size):
        ...
        return pos_enc.view(-1, channels, 1, 1).repeat(1, 1, embed_size, embed_size) ## (batch_size, channels, embed_size, embed_size)
